...
$ mkdir ~/workspace/registry
$ sudo podman run --name registry -p 5000 -v ~/workspace/registry:/var/lib/registry:z -d registry
```
...
$ ls -lZ ~/workspace/registry/docker/registry/v2/repositories/
```
