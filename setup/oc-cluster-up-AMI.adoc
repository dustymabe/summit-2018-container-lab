...
chmod +x /home/ec2-user/rh-container-lab/scripts/host/start-oc.sh
chmod +x /home/ec2-user/rh-container-lab/scripts/host/cleanup-oc.sh
mv /home/ec2-user/rh-container-lab/scripts/host/start-oc.sh ~
mv /home/ec2-user/rh-container-lab/scripts/host/cleanup-oc.sh ~
```
...
```
~/cleanup-oc.sh
rm -rf /home/ec2-user/rh-container-lab
```
